...
/* harmony import */ var next_dist_server_web_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(384);
        ...
        var mod = __webpack_require__(661)
...
const is_key_like_types = ['CryptoKey'];
...
function env_isCloudflareWorkers() {
...
function subtleDsa(alg, algorithm) {
    ...
    switch (alg) {
        ...
        case env_isCloudflareWorkers() && 'EdDSA':
...
;// CONCATENATED MODULE: ./service/jwt_sign_verify.ts

async function jwt_sign_verify_sign(payload, secret) {
...
async function jwt_sign_verify_verify(token, secret) {
