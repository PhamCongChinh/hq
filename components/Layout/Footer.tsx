...
const Footer = (): JSX.Element => {
    return (
        <footer className="bg-blue-500 text-white p-4 border-t">
            <div className="max-w-6xl mx-auto grid grid-flow-row auto-rows-max md:grid-cols-2">
                <div className="grid-cols-1">
                    ...
                    <div>
                        <p className="text-sm"><span className="font-semibold">Website</span> : <Link href={'https://thietbihq.com/'}><a>https://thietbihq.com</a></Link></p>
